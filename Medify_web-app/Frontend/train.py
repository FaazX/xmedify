...
# Initialize session state for disclaimer visibility
if "show_disclaimer" not in st.session_state:
    st.session_state.show_disclaimer = True

# Display the disclaimer if it hasn't been closed
if st.session_state.show_disclaimer:
    st.warning(
        """
        **Disclaimer:**  
        This program is based on machine learning and is for informational purposes only.  
        It is not a substitute for professional medical advice, diagnosis, or treatment.  
        If you have a serious medical condition, please consult a qualified healthcare provider.
        """
    )
    # Add a close button
...
# Sidebar or main app logic
selected = st.sidebar.selectbox("Select a Page", ["Home", "Disease Prediction"])
